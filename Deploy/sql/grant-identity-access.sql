...
-- base de datos.
--
-- Crear las Container Apps con identidad y asignarles roles de Azure no basta:
...
BEGIN
    ...
    -- Solo lectura y escritura de datos, para las dos aplicaciones. Ninguna
    -- necesita modificar el esquema: de las migraciones se encarga el pipeline
    -- con la identidad de infraestructura, así que dar db_owner a los
    -- contenedores sería regalar permisos que nunca van a usar.
    IF NOT EXISTS (
        SELECT 1
