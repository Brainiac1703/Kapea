...
- [ ] 5.6 Dar de alta todos los textos en español e inglés. Se verifica con la prueba de textos sin localizar en verde.

## 6. Cierre

- [ ] 6.1 Actualizar la guía de uso: registrar, editar y borrar a mano, corregir, anular y deshacer, coincidencias, y quitar el límite conocido. Se verifica leyendo la guía y comprobando los enlaces.
- [ ] 6.2 Pasar la batería completa y probar en local dos casos reales: apuntar a mano una compra de XTB e importar después el fichero que la incluye, y corregir un movimiento de Kraken y releer el histórico. Se verifica con las pruebas en verde y las cifras en pantalla.
