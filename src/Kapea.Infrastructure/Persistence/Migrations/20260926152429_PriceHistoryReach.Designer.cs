...
namespace Kapea.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260926152429_PriceHistoryReach")]
    partial class PriceHistoryReach
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kapea.Domain.Assets.WatchedAsset", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WatchedAssets", (string)null);
                });
            ...
            modelBuilder.Entity("Kapea.Domain.MarketData.PriceHistoryReach", b =>
                {
                    b.Property<Guid>("AssetId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("RequestedWith")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.HasKey("AssetId");

                    b.ToTable("PriceHistoryReaches", (string)null);
                });
